              ...
              <div className="flex flex-col gap-2 p-4 bg-gray-50 rounded-xl border border-gray-200">
                ...
                <div className="flex flex-wrap gap-2.5 pt-2">
                  {availablePlots.map((plotItem, idx) => (
                    <div
                      key={idx}
                      className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-xl border transition text-xs font-bold ${plotItem.isSoldOut
                    ...
                    >
                      ...
                      <button
                        ...
                        className={`px-2 py-0.5 rounded-md text-[10px] uppercase tracking-wider font-extrabold transition ${plotItem.isSoldOut
